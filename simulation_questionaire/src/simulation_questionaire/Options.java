...
public class Options {
	...
	public static void displayOptions(){
		...
		for(int i = 0; i < o.size();i++){
			System.out.println(" "+(i+1)+". "+CommonFunctions.refineString(o.get(i).getName()));
		}
	...
	public static void displayAugmentedOptionsAbove(double option, int flag, boolean last, int ii, int jj, int kk, int last_round){
		...
		if(flag == 1){ // options above and equal
			for(int i = 0; i < o.size();i++){
				if(i+1 >= option){
					if(last == true){
						System.out.println(" "+(i+1)+". "+CommonFunctions.refineString(o.get(i).getName())+"   Credit ::"+ df.format(money*getPrivacyOptions(i+1))+"  This option can maintain your privacy");
					}
					else
					{
						System.out.println(" "+(i+1)+". "+CommonFunctions.refineString(o.get(i).getName())+"   Credit ::"+ df.format(money*getPrivacyOptions(i+1))+"  This option can improve your privacy");
					}
					
				}
				else
					System.out.println(" "+(i+1)+". "+CommonFunctions.refineString(o.get(i).getName())+"   Credit ::"+ df.format(money*getPrivacyOptions(i+1)));
			}
		}
			...
			for(int i = 0; i < o.size();i++){
				if(i+1 <= option){
					if(last == true){ // means lower privacy already acheived
						System.out.println(" "+(i+1)+". "+CommonFunctions.refineString(o.get(i).getName())+"   Credit ::"+ df.format(money*getPrivacyOptions(i+1))+"  This option can maintain your credit gain");
					}
					else
					{
						System.out.println(" "+(i+1)+". "+CommonFunctions.refineString(o.get(i).getName())+"   Credit ::"+ df.format(money*getPrivacyOptions(i+1))+"  This option can improve your credit gain");
					}
