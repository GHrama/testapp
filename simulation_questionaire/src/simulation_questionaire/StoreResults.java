...
public class StoreResults {
	...
	public static void displayStatus(int cr){
		...
		System.out.println("Total Privacy Percentage = "+df.format(StoreResults.total_privacy_percentage)+"  Current Round Privacy Percentage = "+df.format(StoreResults.this_round_privacy[cr])+"  Total Credit Obtained = "+df.format(StoreResults.total_credit));
	}
